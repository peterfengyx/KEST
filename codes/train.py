...
def main():
    ...
    #model = model.from_pretrained("../dvae-22275", config=config)
    ...
    #training dataset 108000
    
    unlabelled_dataset=training_dataset.select(range(3240,108000))
    training_dataset=training_dataset.select(range(3240))
    ...
    train_result = trainer.train(#resume_from_checkpoint=last_ckpt,
        ...
        loss_names=['gen_loss', 'cl_loss', 'nag_loss',
                    'nag_ag_loss','total_loss', 'accu', 'f1']
        )
